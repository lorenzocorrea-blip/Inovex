...
Este documento detalha as escolhas de design, cores, fontes e imagens utilizadas na interface do nosso site de vendas de robôs.

## 🎨 Paleta de Cores
* **Cor Principal (Neon):** `#00f2fe` (Utilizada para links, botões principais, bordas de destaque e efeitos hover)
